...
export const mockDashboardData: Array<DashboardModel.RowData> = Array.from({
  length: 20,
}).map(() => {
  ...
  return {
    ...
    entryTipe: faker.helpers.arrayElement(['fiesta', 'celebracion']),
